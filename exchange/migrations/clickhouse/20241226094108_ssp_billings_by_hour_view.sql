...
CREATE materialized view IF NOT EXISTS ssp_billings_by_hour_view TO ssp_billings_by_hour AS
SELECT
    ...
    1 as ssp_billings_count
FROM ssp_billings_consumer;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS ssp_billings_by_hour_view;
-- +goose StatementEnd
