...
CREATE materialized view IF NOT EXISTS dsp_billings_by_hour_view TO dsp_billings_by_hour AS
SELECT
    ...
    toDecimal32(JSONExtractString(msg, 'ssp_response_bid', 'price_in_default_currency'), 6) as ssp_response_price_in_default_currency,
    toDecimal32(JSONExtractString(msg, 'fact_price_ssp_in_default_currency'), 6) as fact_price_ssp_in_default_currency,
    toDecimal32(JSONExtractString(msg, 'fact_price_dsp_in_default_currency'), 6) as fact_price_dsp_in_default_currency,
    1 as dsp_billings_count
FROM dsp_billings_consumer;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS dsp_billings_by_hour_view;
-- +goose StatementEnd
