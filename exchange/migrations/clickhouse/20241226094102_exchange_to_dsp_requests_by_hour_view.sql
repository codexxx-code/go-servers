...
CREATE materialized view IF NOT EXISTS exchange_to_dsp_requests_by_hour_view TO exchange_to_dsp_requests_by_hour AS
SELECT
    ...
    1 as dsp_requests_count
FROM exchange_to_dsp_requests_consumer;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS exchange_to_dsp_requests_by_hour_view;
-- +goose StatementEnd
