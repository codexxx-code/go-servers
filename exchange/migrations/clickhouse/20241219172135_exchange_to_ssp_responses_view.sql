...
CREATE materialized view IF NOT EXISTS exchange_to_ssp_responses_view TO exchange_to_ssp_responses AS
SELECT
...
-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS exchange_to_ssp_responses_view
-- +goose StatementEnd
