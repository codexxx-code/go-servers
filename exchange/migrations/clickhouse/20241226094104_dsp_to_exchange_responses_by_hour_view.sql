...
CREATE materialized view IF NOT EXISTS dsp_to_exchange_responses_by_hour_view TO dsp_to_exchange_responses_by_hour AS
SELECT
    ...
    1 as dsp_responses_count
FROM dsp_to_exchange_responses_consumer;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS dsp_to_exchange_responses_by_hour_view;
-- +goose StatementEnd
