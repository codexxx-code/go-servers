...
CREATE materialized view IF NOT EXISTS exchange_to_ssp_responses_by_hour_view TO exchange_to_ssp_responses_by_hour AS
SELECT
    ...
    1 as ssp_responses_count
FROM exchange_to_ssp_responses_consumer;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP VIEW IF EXISTS exchange_to_ssp_responses_by_hour_view;
-- +goose StatementEnd
