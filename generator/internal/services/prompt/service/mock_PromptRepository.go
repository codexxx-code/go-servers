...
import (
	context "context"
	model "generator/internal/services/prompt/model"
...
func (_m *MockPromptRepository) CreatePrompt(ctx context.Context, req model.CreatePromptReq) (model.CreatePromptRes, error) {
...
func (_m *MockPromptRepository) DeletePrompt(ctx context.Context, req model.DeletePromptReq) error {
	ret := _m.Called(ctx, req)
...
func (_m *MockPromptRepository) GetPrompts(ctx context.Context, req model.GetPromptsReq) ([]model.Prompt, error) {
	ret := _m.Called(ctx, req)
...
func (_m *MockPromptRepository) UpdatePrompt(ctx context.Context, req model.UpdatePromptReq) error {
	ret := _m.Called(ctx, req)
